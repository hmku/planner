...
The planner lets you enter plan years, current net worth, beta mode, SPX beta, acceptable dynamic-beta depletion risk as a decimal from `0` to `1`, simulation count, annual income, and annual expenditures. It then shows:
